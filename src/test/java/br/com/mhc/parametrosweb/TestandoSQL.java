...
public class TestandoSQL {
	...
	public static void main(String[] args) {
		...
		parametrosWeb.add(new ParametrosWeb("nome", matheus.getNome(), null, "="));
		parametrosWeb.add(new ParametrosWeb("idade", matheus.getIdade().toString(), null, "="));
		parametrosWeb.add(new ParametrosWeb("datacadastro", null, null, "is null"));
